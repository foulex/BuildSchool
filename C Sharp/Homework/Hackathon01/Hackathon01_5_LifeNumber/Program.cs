...
namespace Hackathon01_5_LifeNumber
{
    ...
    class Zodiac
    {
        List<string> ZodiacAs = new List<string> { "魔羯", "水瓶", "雙魚", "牡羊", "金牛", "雙子", "巨蟹", "獅子", "處女", "天秤", "天蠍", "射手" };

        private string ZodiacTest(DateTime DT)
        {
            int DM = DT.Month, DD = DT.Day;
            switch (DM)
            {
                case 1: return  DD > 19 ? ZodiacAs[0] : ZodiacAs[1];
                case 2: return  DD > 18 ? ZodiacAs[1] : ZodiacAs[2];
                case 3: return  DD > 20 ? ZodiacAs[2] : ZodiacAs[3];
                case 4: return  DD > 19 ? ZodiacAs[3] : ZodiacAs[4];
                case 5: return  DD > 20 ? ZodiacAs[4] : ZodiacAs[5];
                case 6: return  DD > 21 ? ZodiacAs[5] : ZodiacAs[6];
                case 7: return  DD > 22 ? ZodiacAs[6] : ZodiacAs[7];
                case 8: return  DD > 22 ? ZodiacAs[7] : ZodiacAs[8];
                case 9: return  DD > 22 ? ZodiacAs[8] : ZodiacAs[9];
                case 10: return DD > 23 ? ZodiacAs[9] : ZodiacAs[10];
                case 11: return DD > 22 ? ZodiacAs[10] : ZodiacAs[11];
                default: return DD > 21 ? ZodiacAs[11] : ZodiacAs[0];
            }
        }
        private void LifeNums ()
        {
            ...
            List<string> Z5 = new List<string>
            {
            ...
            List<string> Z6 = new List<string>
            {
            ...
            List<string> Z7 = new List<string>
            {
            ...
            List<string> Z8 = new List<string>
            {
            ...
            List<string> Z10 = new List<string>
            {
            ...
            List<string> Z11 = new List<string>
            {
            ...
            List<string> Z12 = new List<string>
            {
